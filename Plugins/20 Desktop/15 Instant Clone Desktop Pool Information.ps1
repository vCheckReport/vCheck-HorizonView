...
foreach ($pool in $pools){
         ...
         if ($pool.type -like "*automated*" -AND $pool.source -like "*INSTANT_CLONE_ENGINE*"){
...
$Title = "Instant Clone Desktop Pool Status"
$Header = "Instant Clone Desktop Pool Status"
$Comments = "These are the pools that have Instant clones. Not all but the most common status's are counted."
$Display = "Table"
